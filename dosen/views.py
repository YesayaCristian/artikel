...
def detail_dosen(request, id):
    try:
        ...
        data = {
            ...
            "foto_dosen": dosen.foto_dosen.url if dosen.foto_dosen else None,

            # ID akademik
            "sinta_id": dosen.sinta_id,
            "researcher_id": dosen.researcher_id,
            "scopus_author_id": dosen.scopus_author_id,
            "orchid_id": dosen.orchid_id,
            "webpage": dosen.webpage,

            # pendidikan
            "pendidikan_s1": dosen.pendidikan_s1,
            "pendidikan_s2": dosen.pendidikan_s2,
            "pendidikan_s3": dosen.pendidikan_s3,
